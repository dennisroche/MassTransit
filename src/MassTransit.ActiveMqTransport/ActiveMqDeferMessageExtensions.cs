...
namespace MassTransit
{
    ...
    using ActiveMqTransport.Contexts;
    ...
    public static class RabbitMqDeferMessageExtensions
    {
            ...
            where T : class
        {
            if (!context.TryGetPayload(out IMessageScheduler scheduler))
            {
                ...
                var provider = new DelayedExchangeScheduleMessageProvider(context, sessionContext.ConnectionContext.Topology,
                    sessionContext.ConnectionContext.HostAddress);
